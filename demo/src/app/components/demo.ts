...
const demos: any = [
  ...
  { key: 'expandable-section', ts: require('!!raw-loader!./demo/expandable-section/expandable-section.ts'), html: require('!!raw-loader!./demo/expandable-section/expandable-section.html'), readme: require('html-loader?minimize=false!markdown-loader!./demo/expandable-section/README.md'), api: require('html-loader?minimize=false!markdown-loader!./demo/expandable-section/API.md') },
